...
namespace Illuminate\Support\Facades { 
    ...
    class Response {
         ...
         * @static 
         */ 
        public static function jsonException($exception, $http_code = 500)
        {
            return \Illuminate\Routing\ResponseFactory::jsonException($exception, $http_code);
        }
         ...
         * @static 
         */ 
        public static function jsonSuccess($http_code = 200, $object = null, $message = 'successful operation')
        {
            return \Illuminate\Routing\ResponseFactory::jsonSuccess($http_code, $object, $message);
        }
