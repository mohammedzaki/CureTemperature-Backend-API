...
<div class="form-group col-sm-6">
    ...
    {!! Form::number('min_temperature', null, ['class' => 'form-control']) !!}
</div>

<!-- Max Temperature Field -->
<div class="form-group col-sm-6">
    {!! Form::label('max_temperature', 'Max Temperature:') !!}
    {!! Form::number('max_temperature', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('userCates.index') !!}" class="btn btn-default">Cancel</a>
</div>
